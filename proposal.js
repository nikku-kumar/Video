...
function finalReveal() {
  layout(`<section class="screen final-reveal"><div class="card"><div class="reveal-sparkles">✦ ✧ ✦</div><p class="kicker">For my favourite person</p><h2>SURPRISE, Betu 🎁</h2><figure class="photo-frame"><img src="./images/surprise.jpg" data-photo alt="Betu's surprise photo"><figcaption class="photo-caption">This is my favourite person. ❤️<br>My favourite smile.<br>My favourite Betu. 🥰</figcaption></figure><button class="primary" data-next>I Love You ❤️</button></div></section>`, 'final-reveal');
